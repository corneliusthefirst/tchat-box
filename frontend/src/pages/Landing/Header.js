...
export default function Header() {
  ...
  return (
    <div className='bg-tchatbox-heroBackground'>
      {/* Header section */}
      <header className=' w-full sm:w-10/12 mx-auto flex items-center justify-between px-2 sm:px-5 py-4'>
        ...
        <div className='flex flex-row justify-between'>
          {me ? (
            <Link
              to={ME_PAGE}
              className='sm:px-4 px-2 sm:py-2 flex justify-center items-center duration-300 hover:shadow-lg hover:text-tchatbox-indigo rounded-full bg-white text-black sm:text-sm text-xs'
              href='#'
            >
              Open Tchatbox
            </Link>
            ...
            <Link
              to={LOGIN_PAGE}
              className='px-4 py-2 duration-300 hover:shadow-lg hover:text-tchatbox-indigo rounded-full bg-white text-black text-sm'
              href='#'
            >
              Login
            </Link>
      ...
      <nav className={navClass}>
        ...
        <ul className='list-none text-tchatbox-notQuiteDark text-sm text-left pl-2 flex-1 space-y-2 mt-4 pt-4 mx-4 border-t-2 border-tchatbox-offWhite'>
          <li className='text-tchatbox-textLink bg-tchatbox-offWhite p-2 rounded-lg'>
            <a className='text-tchatbox-textLink' href='#'>
              Home
            </a>
          </li>
        ...
        <a
          href='#'
          className='m-3 text-white p-1 rounded-full text-base text-center ease-linear transition duration-150 hover:shadow-lg hover:bg-tchatbox-indigo bg-tchatbox-experiment500'
        >
      ...
      <section className='flex mx-auto md:mt-15 mt-10 p-2 relative overflow-hidden'>
        <div className='z-10 mx-auto flex items-center justify-between flex-col'>
          ...
          <p className='w-full md:w-3/4 lg:w-1/2 text-white md:mt-8 mt-4 sm:leading-8 leading-7 sm:text-base text-sm  tracking-normal md:text-center text-left px-4'>
            Where you can rest connect with your crew
          </p>
        </div>
      </section>
    </div>
